...
<div style="padding-right: 40px">
	<button><a href="javascript:history.back()">Retour</a></button></br>
	<button><a href="javascript:history.go(-3)">Retour à la page d'accueil</a></button>
</div>
	...
	<ul id="menu-demo2">
		...
		<li><a href="#">MOYEN</a>
			<ul>
				...
				<li><?php echo anchor('enseignant/C_enseignant/V_upload_cours', 'Cinquième');?></li>
