	...
	<nav class="btn-info btn-primary">
		...
		<div class="btn btn-primary"  style="width: 1500px">
			<div class="container-header">
				<h2 style="background: darkslategray; padding-right:150px" > Page d'ajout des normes</h2>
			</div>
		</div>
	</nav>

	<?php echo form_open('inspecteur/C_inspecteur/save_norme', ['class'=>'form-horizontal']); ?>
		<fieldset>
			<legend style="font-family: 'Arial Black'; font-size: xx-large">Ajouter une norme</legend>
			<div class="form-group">
				<label for="inputEmail" class="col-md-2 control-label">Cycle</label>
				<div class="col-xs-5">
					<?php echo form_input(['name'=>'cycle', 'placeholder'=>'Cycle', 'class'=>'form-control']);?>
				</div>
				<div class="col-xs-5">
					<h4><?php echo form_error('cycle', '<div class="text-danger">', '</div>');?></h4>
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<?php echo form_input(['name'=>'serie', 'placeholder'=>'Serie', 'class'=>'form-control']);?>
				</div>
				<div class="col-xs-5">
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<?php echo form_input(['name'=>'classe', 'placeholder'=>'Classe', 'class'=>'form-control']);?>
				</div>
				<div class="col-xs-5">
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<?php echo form_input(['name'=>'matiere', 'placeholder'=>'Matiere', 'class'=>'form-control']);?>
				</div>
				<div class="col-xs-5">
			...
			<div class="form-group">
				<div class="col-md-10 col-md-offset-2">
					...
					<?php echo  form_submit(['name'=>'submit', 'value'=>'Enregistrer', 'class'=>'btn btn-primary']); ?>
